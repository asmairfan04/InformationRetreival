...
import openai
#key=api_key='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'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='gpt-3.5-turbo-instruct', choices=['gpt-3.5-turbo-instruct',  'gpt-3.5-turbo',  'gpt-3.5-turbo-0301',  'gpt-4',  'gpt-4-0613'])
